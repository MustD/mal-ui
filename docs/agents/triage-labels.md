...
Because this repo tracks issues as local markdown, a "label" is the value of the `Status:` line near the top of an issue
file — not a tracker-side label object.
