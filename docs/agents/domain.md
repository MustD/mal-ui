...
This repo is **single-context**: one root `CONTEXT.md` and one `docs/adr/`. The Gradle modules (`:core`, `:app:*`,
`:server`) are layering tiers of a single MAL client, not separate bounded contexts.
